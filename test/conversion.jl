...
@testitem "nan_to_zero: scalars" begin
    using Test
    using QuantUtils: nan_to_zero
...
@testitem "nan_to_zero: broadcasting" begin
    using Test
    using QuantUtils: nan_to_zero
...
@testitem "nan_to_one: scalars" begin
    using Test
    using QuantUtils: nan_to_one
...
@testitem "nan_to_one: broadcasting" begin
    using Test
    using QuantUtils: nan_to_one
...
@testitem "nan_to_x: scalars" begin
    using Test
    using QuantUtils: nan_to_x
...
@testitem "nan_to_x: broadcasting" begin
    using Test
    using QuantUtils: nan_to_x
